...
public class ListarPacoteTuristicoPorDestino(IPacoteRepository repository)
{
    public async Task<List<PacoteTuristicoResponseDTO>> ListarPorDestinoAsync(int destinoId)
    {
        var models = await repository.ListarPacotesPorDestino(destinoId);
